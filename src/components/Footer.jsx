                  ...
                  <div className="contact_us">
                    ...
                    <ul className="fa-ul">
                      <li className="pd-right">
                        <i className="ph ph-gps-fix fa-li"></i>
                      ...
                      <li>
                        <i className="ph ph-phone  fa-li"></i>
                        <div style={{ marginTop: "-50px" }}>
                          <br />
                          <p>(12) 3 456 7890</p>
                          <p>(12) 3 456 7890</p>
                      ...
                      <li>
                        <i className="ph ph-envelope fa-li"></i>
                        <div style={{ marginTop: "-50px" }}>
                          <br />
                          <p>
                            <a href="mailto:contact@grabngo.com">
                              contact@grabngo.com
                            </a>
                          </p>
                          <p>
                ...
                <div className="col-phone-12 col-xs-6 col-sm-3 col-md-2 column column1">
                  ...
                  <ul>
                    <li>
                      ...
                      efficient solution for managing grocery inventories,
                      helping small stores streamline processes, reduce waste,
